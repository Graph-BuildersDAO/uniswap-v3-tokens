...
export function updateTokenHourData(token: Token, event: ethereum.Event): TokenHourData {
  ...
  archiveHourData(BigInt.fromI32(hourStartUnix - 2678400), token) //current minute minus 86400 seconds (31 days prior)
...
export function updateTokenMinuteData(token: Token, event: ethereum.Event): TokenMinuteData {
  ...
  archiveMinuteData(BigInt.fromI32(minuteStartUnix - 86400), token) //current minute minus 86400 seconds (1 day)
